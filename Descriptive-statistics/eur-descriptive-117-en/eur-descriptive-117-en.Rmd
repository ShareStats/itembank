...
include_supplement("eur-descriptive-117-en-data.sav", recursive = TRUE)
include_supplement("eur-descriptive-117-en-data.csv", recursive = TRUE)
```
...
* Download**: [SPSS file](eur-descriptive-117-en-data.sav), [CSV file](eur-descriptive-117-en-data.csv)
