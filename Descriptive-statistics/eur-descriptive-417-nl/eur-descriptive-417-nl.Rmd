...
Maak een groep met daarin de 33,333% hoogst scorende adolescenten op de schaalscore (variabele [schaal]). Wat is het gemiddelde van deze groep op de variabele [IQ]? (2 decimalen)
