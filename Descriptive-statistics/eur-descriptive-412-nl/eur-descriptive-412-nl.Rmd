...
Hoeveel adolescenten hebben een schaalscore (variabele [schaal]) die meer dan 2 standaarddeviaties boven het groepsgemiddelde ligt? (geen decimalen)
...
Solution
========
Het aantal adolescenten met een schaalscore die meer dan 2 standaarddeviaties boven het gemiddelde ligt is drie (bereken z-scores en zoek naar z-scores groter dan 2).

Meta-information
================
exname: eur-descriptive-412-nl
extype: num
exsolution: 3
extol: 0
