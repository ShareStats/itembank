...
include_supplement("eur-inferential_statistics-252-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-252-en-data.csv", recursive = TRUE)
```
Question
========
...
**Download**: [SPSS file](eur-inferential_statistics-252-en-data.sav), [CSV file](eur-inferential_statistics-252-en-data.csv)
...
Meta-information
================
exname: eur-inferential_statistics-252-en
extype: num
exsolution: 0.144
extol: 0
exsection: Inferential Statistics/Regression/R squared, Inferential Statistics/Regression/Multiple linear regression/R squared change
