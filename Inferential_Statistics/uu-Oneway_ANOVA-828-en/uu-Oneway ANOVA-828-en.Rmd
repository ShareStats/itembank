...
Answerlist
----------
* The groups do not differ significantly in their scores on reading comprehension.
...
* There are significant differences between the means. the differences between the groups in a quiet room and with background noise, and the groups with background noise and disruptive noise are significant.
* There are significant differences between the averages. All three averages are significantly different from each other.
