...
Suppose we compare two fictional individuals, Dušan and Hakim. Both individuals have a migration background, and both individuals belong to the same age group. Dušan's educational level (WO; score = 5) is one category higher than Hakim's educational level (HBO; score
= 4).  
...
Answerlist
----------
* Dušan has 0.179 more confidence in the police than Hakim, expressed on a scale of 1 to 10.
* Dušan has 0.179 more confidence in the police than Hakim, expressed on a scale of 0 to 1.
* Dušan has 0.895 (calculated as follows: 0.179 \* 5 = 0.895) more trust in the police than Hakim, expressed on a scale of 0 to 1.
* Dušan has 0.895 (calculated as follows: 0.179 \* 5 = 0.895) more trust in the police than Hakim, expressed on a scale of 1 to 10.
