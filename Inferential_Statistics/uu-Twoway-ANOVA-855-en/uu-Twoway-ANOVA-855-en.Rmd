...
Question
========
Below is the SPSS output of a study of the effects of worked examples (WORKED with 0 = no worked examples and 1 = worked examples) on students' performance on a test (TOETS rated with a grade of 1 - 10). This also distinguished the prior knowledge students had about the topic (FORKNOWLED with 0 = little prior knowledge and 1 = a lot of prior knowledge).
