...
include_supplement("eur-inferential_statistics-127-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-127-en-data.csv", recursive = TRUE)
```
...
What is the average amount of error variance (Mean Square Error) in this model? (3 decimals)

**Download**: [SPSS file](eur-inferential_statistics-127-en-data.sav), [CSV file](eur-inferential_statistics-127-en-data.csv)
...
Meta-information
================
exname: eur-inferential_statistics-127-en
extype: num
exsolution: 6.243
extol: 0
