...
Question
========
The following questions involve data from 1,770 people (N=1770) who were interviewed on street were interviewed about their contact and experiences with the police. These data come from a large-scale survey among the Amsterdam population that was set up by Anne Wester (Talentenlab) and Jair Schalkwijk (Control Alt Delete).  
  
The survey included the question of whether, during the past 12 months had ever had contact with the police (yes or no). If someone indicated they had had contact, the follow-up question was asked how the last contact occurred: did the police come to the respondent, or did the respondent go to the police themselves?  
...
* Table 1**: The correlation between age and contact with police. Observed numbers, with standardized residual (*standardized residual*) in parentheses.  
![](1641292970572.png)

Answerlist
----------
* There are **more **respondents in this cell than you would expect if there were *no* correlation at all between age and contact with police.  
  This difference is significant (if we use a significance level of 5% use), because the value 4.2 is greater than 1.96.
* There are **less** respondents in this cell than you would expect if there were *no* association between age and contact with police.  
  This difference is significant (if we use a significance level of 5% use), because the value 4.2 is greater than 1.96.
* There are **more **respondents in this cell than you would expect if there were *no* association between age and contact with police.  
...
Meta-information
================
exname: vufsw-chisquared-0064-en
extype: schoice
exsolution: 1000
exshuffle: TRUE
