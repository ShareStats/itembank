...
include_supplement("eur-inferential_statistics-230-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-230-en-data.csv", recursive = TRUE)
```
...
* Download**: [SPSS file](eur-inferential_statistics-230-en-data.sav), [CSV file](eur-inferential_statistics-230-en-data.csv)
...
Meta-information
================
exname: eur-inferential_statistics-230-en
extype: num
exsolution: 0.141
extol: 0
