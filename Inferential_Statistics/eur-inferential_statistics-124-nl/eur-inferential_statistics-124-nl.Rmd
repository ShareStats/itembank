...
include_supplement("eur-inferential_statistics-124-nl-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-124-nl-data.csv", recursive = TRUE)
```
...
Wat is in dit model de gestandaardiseerde regressiecoëfficiënt voor uitgaven in juli 2012 [expenses_jul]? (3 decimalen)

**Download**: [SPSS file](eur-inferential_statistics-124-nl-data.sav), [CSV file](eur-inferential_statistics-124-nl-data.csv)


Solution
========
De gestandaardiseerde regressiecoëfficiënt voor uitgaven in juli 2012 is 0.729.


Meta-information
================
exname: eur-inferential_statistics-124-nl
extype: num
exsolution: 0.729
extol: 0
