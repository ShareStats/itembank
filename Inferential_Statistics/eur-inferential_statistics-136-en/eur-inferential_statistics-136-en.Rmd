...
include_supplement("eur-inferential_statistics-136-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-136-en-data.csv", recursive = TRUE)
```
...
Report the standardized regression coefficient for driven kilometers in October 2014 [KM_OCT]? (3 decimals)

**Download**: [SPSS file](eur-inferential_statistics-136-en-data.sav), [CSV file](eur-inferential_statistics-136-en-data.csv)


Solution
========
The standardized regression coefficient for driven kilometers in October 2014 is 0.729.


Meta-information
================
exname: eur-inferential_statistics-136-en
extype: num
exsolution: 0.729
extol: 0
