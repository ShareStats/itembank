...
include_supplement("eur-inferential_statistics-225-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-225-en-data.csv", recursive = TRUE)
```
...
* Download**: [SPSS file](eur-inferential_statistics-225-en-data.sav), [CSV file](eur-inferential_statistics-225-en-data.csv)
