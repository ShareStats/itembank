...
1: Participants in the 'error management' group, prior to the experiment in self-discipline from those in the 'error prevention' group 2: Taking into account existing differences in self-discipline, the error management instruction leads to higher performance on the task task than the 'error prevention' instruction
