...
include_supplement("eur-inferential_statistics-249-en-data.sav", recursive = TRUE)
include_supplement("eur-inferential_statistics-249-en-data.csv", recursive = TRUE)
```
Question
========
...
**Download**: [SPSS file](eur-inferential_statistics-249-en-data.sav), [CSV file](eur-inferential_statistics-249-en-data.csv)
...
Meta-information
================
exname: eur-inferential_statistics-249-en
extype: num
exsolution: 0.218
extol: 0
