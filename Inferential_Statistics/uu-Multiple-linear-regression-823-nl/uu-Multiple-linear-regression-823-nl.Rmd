...
Gebaseerd op bovenstaande output, wat concluderen we met betrekking tot de verschillende toetsen die we doen?

Answerlist
----------
* Het volledig model is significant en alle afzonderlijke predictoren zijn significant
* Het volledig model is significant maar niet alle afzonderlijke predictoren zijn significant 
* Het volledig model is niet significant, maar alle afzonderlijke predictoren zijn wel significant
* Het volledig model is niet significant en niet alle afzonderlijke predictoren zijn significant
...
Meta-information
================
exname: uu-Multiple-linear-regression-823-nl.Rmd
extype: schoice
exsolution: 0100
