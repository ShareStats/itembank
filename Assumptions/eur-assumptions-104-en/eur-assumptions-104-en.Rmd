...
include_supplement("eur-assumptions-104-en-data.sav", recursive = TRUE)
include_supplement("eur-assumptions-104-en-data.csv", recursive = TRUE)
```
...
* Download**: [SPSS file](eur-assumptions-104-en-data.sav), [CSV file](eur-assumptions-104-en-data.csv)
