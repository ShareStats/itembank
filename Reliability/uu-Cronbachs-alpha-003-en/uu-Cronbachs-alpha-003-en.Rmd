...
I. Removing items creates the danger of affecting content validity. 
II. Because the scale consists of only 6 items, the scale with all 6 items will be more reliable than a scale with only 5 or even only 4 items.
