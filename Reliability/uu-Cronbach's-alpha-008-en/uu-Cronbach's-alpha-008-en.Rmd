...
Question
========
The SPSS output below presents the reliability analysis for the Negative Fear of Failure scale, based on data from the Performance Motivation Test for Children (PMTC).
